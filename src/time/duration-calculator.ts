...
import { DurationRowElement } from "./duration-row.js";
import { DisplayTimeElement } from "./display-time.js";

export class DurationCalculatorElement extends HTMLElement {
  static tag = "mushy-duration-calculator";
  ...
  constructor() {
    ...
    this.#time = document.createElement(DisplayTimeElement.tag);
    ...
    addButton.addEventListener(
      ...
      () =>
        this.#rowContainer.appendChild(
          document.createElement(DurationRowElement.tag),
        ),
    );
  ...
  mainCalc() {
    ...
    for (const row of this.#rowContainer.children as HTMLCollectionOf<DurationRowElement>) {
...
customElements.define(DurationCalculatorElement.tag, DurationCalculatorElement);
