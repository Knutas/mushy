...
export class DurationRowElement extends HTMLElement {
  ...
  constructor() {
    ...
    this.#joinTimeTime = document.createElement(DisplayTimeElement.tag);
...
customElements.define(DurationRowElement.tag, DurationRowElement);
